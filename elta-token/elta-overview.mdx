...
- Staking ELTA tokens to earn rewards and further support the Elata ecosystem.
- A portion of ELTA will be strategically set aside for bounties, grants, advisory positions, and other miscellaneous community initiatives.
- Those who support Elata's open source project portfolio (EOP portfolio) will be able to receive task & bug bounties that will be disseminated throughout the Elata community.
