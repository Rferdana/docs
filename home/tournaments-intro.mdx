...
| \$ELTA stakers | - Tournaments contribute fees back into Elata’s shared revenue pool (the “tournament rake”), which is then split between app stakers, veELTA stakers, and the treasury. - This ties fun, user-facing events directly into the health and sustainability of the overall ecosystem. |
