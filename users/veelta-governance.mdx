...
<Card title="Lock ELTA" icon="lock" href="https://app.elata.bio/rewards">
...
<CardGroup cols={2}>
  <Card title="Lock ELTA Now" icon="lock" href="https://app.elata.bio/rewards">
    Start earning protocol rewards
  </Card>
  <Card title="Learn Tokenomics" icon="chart-pie" href="/learn/tokenomics">
